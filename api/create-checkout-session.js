  ...
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      shipping_address_collection: {
        allowed_countries: ['BE', 'NL', 'LU', 'DE', 'AT', 'HR', 'BG'],
      },

      shipping_options: [
        {
          shipping_rate: 'shr_1T94qCBXhwclDGqt1KCSmUhb'
        },
        {
          shipping_rate: 'shr_1T94qxBXhwclDGqtyvmrSDUz'
        },
        {
          shipping_rate: 'shr_1T94sWBXhwclDGqty8GE9upG'
        }
      ],
